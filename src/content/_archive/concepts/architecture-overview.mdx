---
title: "Architecture Overview — For Experienced Developers"
description: "How tools, skills, and MCP stack together — the three extensibility primitives, the host routing layer, and the mental model that ties them all."
module: "how-agents-work"
order: 0
audiences: ["experienced-dev"]
estimatedMinutes: 8
tags: ["architecture", "tools", "mcp", "skills", "overview"]
---

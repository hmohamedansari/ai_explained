---
title: "Tools: A Deep Dive"
description: "What tools actually are, how the request/execute/return loop works, parallel calls, error handling, and how to write tool definitions that the model uses correctly."
module: "how-agents-work"
order: 2
audiences: ["new-dev", "experienced-dev", "sre-devops"]
estimatedMinutes: 15
tags: ["tools", "function-calling", "api", "json-schema"]
---

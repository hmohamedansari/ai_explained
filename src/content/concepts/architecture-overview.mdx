---
title: "Architecture Overview: Tools, Skills, and MCP"
description: "How the three extensibility primitives of Claude Code stack together — and the single mental model that ties them all."

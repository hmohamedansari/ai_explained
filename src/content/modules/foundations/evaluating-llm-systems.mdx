...
```python
# Rubric-based scoring for summarisation
...
def judge_pairwise(prompt: str, output_a: str, output_b: str) -> str:
    """Returns 'A', 'B', or 'TIE'."""
    response = client.messages.create(
        model="claude-opus-4-6",  # stronger model as judge
        max_tokens=8,
        system=(
...
- [Evaluation — Anthropic documentation](https://docs.anthropic.com/en/docs/test-and-evaluate/eval-intro) — Anthropic's guidance on building and running evals for Claude-based systems.

...
- Usage policies: each provider publishes what their model is and isn't permitted to do; this is the safety baseline your application builds on: [Anthropic](https://www.anthropic.com/legal/usage-policy) · [OpenAI](https://openai.com/policies/usage-policies) · [Google](https://ai.google.dev/gemini-api/terms).
- [Constitutional AI: Harmlessness from AI Feedback](https://arxiv.org/abs/2212.08073); Bai et al., 2022. Foundational paper on training safety properties via AI feedback; the technique behind Anthropic's approach and influential across the field.

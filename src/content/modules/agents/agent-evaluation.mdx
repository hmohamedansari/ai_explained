...
class AgentVersionRouter:
    def __init__(self, versions: dict[str, float]):
        ...
        self.population = [
            v for v, weight in versions.items()
    ...
    def select(self, session_id: str) -> str:
        ...
        idx = hash(session_id) % len(self.population)
...
- [Evaluating Language-Model Agents on Realistic Autonomous Tasks](https://arxiv.org/abs/2312.11671) — Kinniment et al., 2023. ARC evaluation framework for realistic tasks; trajectory evaluation methodology.

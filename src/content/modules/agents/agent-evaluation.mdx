...
- [Terminal-Bench](https://www.tbench.ai/); Standardised benchmark suite for evaluating agents on real terminal tasks across software engineering, ML, security, and data science domains; includes a public leaderboard.

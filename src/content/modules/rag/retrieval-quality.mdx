...
This is the out-of-vocabulary (OOV) problem: proprietary product names, internal error codes, recent proper nouns, and domain-specific jargon are all candidates for poor dense retrieval. BM25 doesn't suffer from this — it's a character-level comparison, and a match is a match regardless of training data.

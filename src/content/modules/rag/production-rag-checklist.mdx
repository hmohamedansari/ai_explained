...
- [RAGFlow](https://ragflow.io/); Open-source RAG engine with built-in document ingestion, hybrid retrieval, and workflow orchestration. A batteries-included alternative if you want to skip building the pipeline from primitives.

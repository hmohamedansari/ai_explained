...
**Latency cost:** N+1 LLM calls (1 to generate variations + 1 per query to embed and search). Use a fast model for generation; cache common query expansions if traffic patterns repeat.

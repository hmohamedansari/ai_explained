...
| **HTTP + SSE** | Remote tools, shared services | ~10–100ms | Network service; scalable |
| **WebSocket** | Real-time bidirectional | ~5–20ms | Long-lived connections |

For production multi-tenant deployments, HTTP+SSE is the norm. stdio is the default for local development and desktop agents.
...
| Transport | N/A (in-process) | stdio, HTTP+SSE |

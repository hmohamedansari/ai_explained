...
- [A Developer's Guide to AI Agent Protocols](https://developers.googleblog.com/developers-guide-to-ai-agent-protocols/); Google Developers, 2025. Frames MCP, A2A, AG-UI, AP2, UCP, and A2UI as complementary layers of the emerging agentic web stack.

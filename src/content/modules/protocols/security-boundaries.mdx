...
- [Prompt injection attacks against GPT-4](https://arxiv.org/abs/2302.12173) — Perez & Ribeiro, 2022. Early empirical study establishing the attack surface; the patterns identified remain current.
- [Indirect Prompt Injection — Greshake et al.](https://arxiv.org/abs/2302.12173) — Analysis of injection via retrieved content, with specific examples of web-browsing and email-reading agents being hijacked.
